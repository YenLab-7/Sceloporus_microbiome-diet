...
dist.q1 <- hill_pair_dis$q1S %>% as.matrix()
...
q1_intrasp<-dist.q1.meta.filt %>% 
  ...
  theme(legend.text = element_text(face = "italic"))+
  stat_pvalue_manual(Post_hoc.q1, hide.ns = TRUE) +
  labs(
    subtitle = get_test_label(kruskal.t.q1, detailed = TRUE),
...
dist.q2 <- hill_pair_dis$q2S %>% as.matrix()
 ...
 ggboxplot(x = "Species.order", y="value", fill = "Species.order")+
  ...
  scale_fill_manual(values = c("#999999","#E69F00","#56B4E9","#009E73","#F0E442"))+
   ...
   theme(legend.position = "right",
        ...
        legend.title = element_blank()) +
  theme(legend.text = element_text(face = "italic"))+
  stat_pvalue_manual(Post_hoc.q2, hide.ns = TRUE) +
  labs(
    subtitle = get_test_label(kruskal.t.q2, detailed = TRUE),
